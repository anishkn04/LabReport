...
<nav>
    <div class="heading"><img style="height: 3em;" src="../images/website-logo.png"></div>
    <div class="heading">Lab Report Management System</div>
    <ul class="nav-items">
    ...
    if(!isset($_SESSION['username'])){
        ...
        echo("<a id='button' href='../php/logout.php'>Logout</a>");
    }?>
</nav>